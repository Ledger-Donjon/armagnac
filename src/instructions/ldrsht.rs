//! Implements LDRSHT (Load Register Signed Halfword Unprivileged) instruction.
...
impl Instruction for Ldrsht {
    fn patterns() -> &'static [Pattern] {
        &[Pattern {
            encoding: T1,
            versions: &[V7M, V7EM, V8M],
            expression: "111110010011xxxxxxxx1110xxxxxxxx",
        }]
    }
    ...
    fn execute(&self, proc: &mut Processor) -> Result<Effect, RunError> {
        ...
        let value = proc.read_u16_unaligned_with_priv(address, false)? as i16 as i32 as u32;
